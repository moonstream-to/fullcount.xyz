    ...
    <div className={styles.container}>
      ...
      <div className={styles.cardsContainer}>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.cardText}>
            The more you play, the more richness you add to your character’s heat maps,
            achievements, and stats. Track your path to the big leagues — and psyche out your
            opponents! — as your record grows.
          </div>
        </div>
      </div>
