...
export const GameContextProvider: FC<ProviderProps> = ({ children }) => {
    const [contextState, setContextState] = useState<GameContextProps>({
        ...
        vertical: 0,
        horizontal: 0,
        contractAddress: process.env.NEXT_PUBLIC_CONTRACT_ADDRESS ?? "0x9b81f7b0F4445b022EDD1109fe438d2E4484A1c5",
        chainId: Number(process.env.NEXT_PUBLIC_CHAIN_ID) ?? 322,
        tokenAddress: process.env.NEXT_PUBLIC_TOKEN_ADDRESS ?? "0xF674839663C9353379b48fEb2AFb019a07CA00F4",
        selectedToken: -1,
        sessionId: 0,
    });
